...
<head>
	<script type="text/javascript">
		function sureToApprove(ca_id)
		{
			...
			{
				window.location.href='continue_category.php?ca_id='+ca_id;
			}
		}
	</script>
	<style>
	...
	<form>
		...
		<table style="width:100%" id="fb" font color="white">
			...
			<?php
				...
				$select="SELECT * FROM category WHERE category.available=0";
		...
		<tr>
			...
			<td><a href="javascript:sureToApprove(<?php echo $row['ca_id'];?>)">CONTINUE</a></td>
		</tr>
		<?php
	}
	?>
